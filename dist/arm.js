(function(root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        root.Arm = factory(root, {}, root.jQuery || root.Zepto || root.$ || root.Arm_$);
    }
    ...
    var _ = Arm._ || {};
    $ = $ || _;
    var doc = document, breaker = {}, console = root.console, logger = console || {}, version = "1.0.1";
    if (!logger.log) {
        logger.log = function() {};
    ...
    Arm.View = null;
    var Base = root["Base"] || {};
    var arrPro = Array.prototype, objPro = Object.prototype, strPro = String.prototype, fnPro = Function.prototype;
    var push = arrPro.push, slice = arrPro.slice, splice = arrPro.splice, concat = arrPro.concat, toString = objPro.toString, hasOwnProperty = objPro.hasOwnProperty;
    var _forEach = arrPro.forEach, _map = arrPro.map, _reduce = arrPro.reduce, _filter = arrPro.filter, _every = arrPro.every, _some = arrPro.some, _indexOf = arrPro.indexOf, _lastIndexOf = arrPro.lastIndexOf, _isArray = Array.isArray, _keys = Object.keys, _bind = fnPro.bind;
    _ = {
        ...
        isJSONType: function(obj) {
            if (_.isString(obj) || _.isNumber(obj) || _.isBoolean(obj) || _.isObject(obj) || _.isArray(obj) || obj === null) {
                return true;
            }
            return false;
        },
        ...
        isEqual: function(one, two) {
            ...
            switch (className) {
              ...
              case "[object RegExp]":
                return one.source == two.source && one.global == two.global && one.multiline == two.multiline && one.ignoreCase == two.ignoreCase;
            ...
            for (var attr in map) {
                if (hasOwnProperty.call(obj, attr)) {
                    if (keyMapIsStr) {
                        ...
                        obj[attr] = typeof map[attr] == "function" ? map[attr](obj[attr], obj) : map[attr] === undefined || map[attr] === null ? formater(obj[attr], obj) : map[attr];
                    }
                }
            }
            return obj;
        ...
        extend: function(first, obj, source) {
            var args, depth, origin, src, clone, dest;
            ...
            _.each(slice.call(args, 2), function(source) {
                if (source) {
                    for (var prop in source) {
                        dest = origin[prop];
                        src = source[prop];
                        if (!source.hasOwnProperty(prop) && (source instanceof HashMap || source instanceof ArrayList)) {
                            continue;
                        }
                        if (dest === src) {
                            continue;
                        }
                        if (depth > 0 && (_.isObjectOrMap(src) || _.isArrayOrList(src))) {
    ...
    var _util = {
        ...
        addModuleForName: function(name, moduleName) {
            ...
            var module = "", hasModuleName = true, dotIdx = name.indexOf(".");
            if (dotIdx < 0) {
                hasModuleName = false;
            } else {
    ...
    ArrayList.prototype = {
        ...
        add: function(item, valid) {
            ...
            var model, list = _.isArrayOrList(item) ? item : [ item ];
        ...
        swapOrder: function(fromOrder, toOrder) {
            if (fromOrder < 1 || toOrder < 1 || fromOrder > this.length || toOrder > this.length || fromOrder == toOrder) {
                return this;
            }
    ...
    _.each([ "entries", "every", "filter", "forEach", "join", "keys", "map", "pop", "push", "reduce", "reduceRight", "reverse", "shift", "slice", "some", "sort", "splice", "unshift" ], function(method) {
    ...
    Action.prototype = {
        ...
        getClass: function(name, options, isNew, type) {
            ...
            var len = name.length, typeLen = type.length;
        ...
        get: function(name, options, isNew, moduleInfo) {
            ...
            fullName = fullName.substring(0, module.name.length) != module.name ? module.name + "." + fullName : fullName;
        ...
        _createView: function(data, config) {
            ...
            _.extend(View.prototype, {
                find: function(selector) {
                    return this.getContainer().find ? this.getContainer().find(selector) : this.getContainer().querySelectorAll(selector);
                },
            ...
            events = [ "mouseup", "mousemove", "mousedown", "mouseover", "mouseleave", "mouseout", "click", "dbclick", "drag", "dragstart", "dragend", "drop", "keydown", "keypress", "keyup" ];
